...
define("_FAQ_INSERTFAQ", "Εισαγωγή εγγραφής στο FAQ");
define("_FAQ_GOTOFAQPAGE", "Μετάβαση στη σελίδα του FAQ");
define("_FAQ_FAQPAGE", "FAQ");
define("_FAQ_QUESTION", "Ερώτηση");
define("_FAQ_ANSWER", "Απάντηση");
define("_FAQ_NOFAQFOUND", "Δεν υπάρχουν εγγραφές στο FAQ");
define("_FAQ_QUESTIONS", "Ερωτήσεις");
define("_FAQ_ANSWERS", "Απαντήσεις");
define("_FAQ_FAQLIST", "Λίστα FAQ");
define("_FAQ_ADDFAQ", "Προσθήκη εγγραφής στο FAQ");
define("_FAQ_EDITFAQ", "Επεξεργασία εγγραφής FAQ");
define("_FAQ_DELETEFAQ", "Διαγραφή εγγραφής FAQ");
define("_FAQ_CHANGEFAQORDER", "Αλλαγήτης σειράς των ερωτήσων του FAQ");
define("_FAQ_SUCCESFULLYDELETEDFAQENTRY", "Η εγγραφή του FAQ διαγράφηκε επιτυχώς");
