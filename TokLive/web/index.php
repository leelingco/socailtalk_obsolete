		...
		<div class='container stage'>
			...
			<div class='content'>
				<div class='left'>
					...
					<ul class='steps'>
						<li><img src="images/circle-1.png" alt="1"><a></a><button onclick='createSession()' id='create-chartroom'>create a chatroom</button></button></li>
						<li id='twitter-section'><img src="images/circle-2.png" alt="2"><img src='images/sign-in-with-twitter-gray.png' id='twitter-button' style='width:158px;height:28px' onclick='twitterConnect()'></li>
